                                                    ...
                                                    <div class="jplist-panel box panel-top">
                                                        ...
                                                        <div data-control-type="drop-down" data-control-name="paging" data-control-action="paging" class="jplist-drop-down form-control">
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><span data-number="all"> Veure tots</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="text-filter-box">
                                                            <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input data-path=".title" type="text" value="" placeholder="Cerca per nom" data-control-type="textbox" data-control-name="title-filter" data-control-action="filter" class="form-control"/></div>
                                                        </div>
                                                    ...
                                                    <div class="box text-shadow">
                                                        <table class="demo-tbl"><!--<item>1</item>-->
                                                            <tr class="tbl-item"><!--<img/>-->
                                                                <td class="col-lg-2"><img src="img/DSC07735_1.JPG" alt="" title="" class="img-thumbnail"/></td>
                                                                <!--<data></data>-->
                                                                <td class="td-block"><p class="date">Data matriculació: 03/15/2012</p>

                                                                    <p class="title">AVPC-1</p>

                                                                    <p class="desc">

                                                                    <div class="row">
                                                                        <div class="col-lg-4">
                                                                            <h7 class="box-heading">Marca</h7>
                                                                            <div class="well well-sm">Nissan</div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <h7 class="box-heading">Model</h7>
                                                                            <div class="well well-sm">12345678</div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <h7 class="box-heading">Matricula</h7>
                                                                            <div class="well well-sm">B-12345-AB</div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <a class="btn-xs btn-default" href="#">Configuració</a>
                                                                        </div>
                                                                    </div>
                                                                    </p>
                                                            ...
                                                            <!--<item>2</item>-->
                                                            <tr class="tbl-item"><!--<img/>-->
                                                                <td class="img"><img src="/images/thumbs/car-1.jpg" alt="" title="" class="center-block"/></td>
                                                                <!--<data></data>-->
                                                                <td class="td-block"><p class="date">Data Matriculació: 03/15/1976</p>

                                                                    <p class="title">AVPC-2</p>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-4">
                                                                            <h7 class="box-heading">Marca</h7>
                                                                            <div class="well well-sm">Renault</div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <h7 class="box-heading">Model</h7>
                                                                            <div class="well well-sm">kangoo</div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <h7 class="box-heading">Matricula</h7>
                                                                            <div class="well well-sm">B-12345-AB</div>
                                                            ...
                                                            <!--<item>3</item>-->
                                                            <tr class="tbl-item"><!--<img/>-->
                                                                <td class="col-lg-2"><img src="img/DSC07735_3.JPG" alt="" title="" class="img-thumbnail"/></td>
                                                                <!--<data></data>-->
                                                                <td class="td-block"><p class="date">Data Matriculació: 03/15/1976</p>

                                                                    <p class="title">AVPC 50/3</p>

                                                                    <p class="desc">

                                                                    <div class="row">
                                                                        <div class="col-lg-4">
                                                                            <h7 class="box-heading">Mitsubishi</h7>
                                                                            <div class="well well-sm">Renault</div>
                                                                            </div>
                                                                            <div class="col-lg-4">
                                                                                <h7 class="box-heading">Model</h7>
                                                                                <div class="well well-sm">LT123</div>
                                                                            </div>
                                                                            <div class="col-lg-4">
                                                                                <h7 class="box-heading">Matricula</h7>
                                                                                <div class="well well-sm">B-12345-AB</div>
                                                    ...
                                                    <div class="jplist-panel box panel-bottom">
                                                        <div data-control-type="drop-down" data-control-name="paging" data-control-action="paging" data-control-animate-to-top="true" class="jplist-drop-down form-control">
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><span data-number="5"> 5 per pàgina</span></li>
                                                                <li><span data-number="10" data-default="true"> 10 per pàgina</span></li>
                                                                <li><span data-number="all"> Veure tot</span></li>
                                                            </ul>
                                                        </div>
                                                        <div data-control-type="drop-down" data-control-name="sort" data-control-action="sort" data-control-animate-to-top="true" data-datetime-format="{month}/{day}/{year}" class="jplist-drop-down form-control">
                                                            <ul class="dropdown-menu">
                                                                <li><span data-path="default">Sort by</span></li>
                                                                <li><span data-path=".title" data-order="asc" data-type="text">Nom A-Z</span></li>
                                                                <li><span data-path=".title" data-order="desc" data-type="text">Nom Z-A</span></li>
                                                                <li><span data-path=".date" data-order="asc" data-type="datetime">Data asc</span></li>
                                                                <li><span data-path=".date" data-order="desc" data-type="datetime">Data des</span></li>
                                                            </ul>
                                                        </div>
