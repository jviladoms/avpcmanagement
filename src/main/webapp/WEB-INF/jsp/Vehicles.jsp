                                                ...
                                                <div id="grid-layout-table-1" class="box">
                                                    <div class="box text-shadow">
                                                        <table class="demo-tbl"><!--<item>1</item>-->
                                                            <button type="button" onclick="window.location.href='/admin/vehicles_registration'" class="btn btn-default">Afegir vehicle<i class="fa fa-plus mls"></i></button>
                                                            <c:if test="${fromDelete}"> vehicle ${vehicle.credential} successfully Deleted</c:if>
                                                            <c:forEach items="${vehicles}" var="vehicle">
                                                            <tr class="tbl-item"><!--<img/>-->
                                                                    <td class="col-lg-2"><img src="/vehicle/image/display?name=${vehicle.id}" alt="" title="" class="img-responsive img-thumbnail"/></td>
                                                                    <!--<data></data>-->
                                                                    <td class="td-block"><p class="date">Data matriculació: ${vehicle.registrationNumber}</p>

                                                                        <p class="title">${vehicle.credential}</p>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-4">
                                                                                ...
                                                                                <div class="well well-sm">${vehicle.brand}</div>
                                                                            </div>
                                                                            <div class="col-lg-4">
                                                                                <h7 class="box-heading">Model</h7>
                                                                                <div class="well well-sm">${vehicle.model}</div>
                                                                            </div>
                                                                            <div class="col-lg-4">
                                                                                <h7 class="box-heading">Matricula</h7>
                                                                                <div class="well well-sm">${vehicle.registrationNumber}</div>
                                                                            </div>
                                                                            <div class="col-lg-4">
                                                                                <a class="btn-xs btn-default" href="/admin/vehicle_update/${vehicle.id}">Configuració</a>
                                                                            </div>
                                                                        </div>
                                                                        </p>
